-- Code from https://github.com/kev-zheng/hammerspoon
...
local commandoptionshift = {"command","alt","⇧"}

hotkey.bind(commandoptionshift, "left", nil,
	    function() moveWindowOneSpace("left", true) end)
hotkey.bind(commandoptionshift, "right",nil,
